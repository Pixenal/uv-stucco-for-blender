...
RUVM_BLENDER_EXPORT void ruvmBlenderQueryCommonAttribs(RuvmMesh *pMesh,
													   char *pMapName,
													   RuvmCommonAttribList *pCommonAttribs);
RUVM_BLENDER_EXPORT void ruvmBlenderDestroyCommonAttribs(RuvmCommonAttribList *pCommonAttribs);
RUVM_BLENDER_EXPORT void ruvmBlenderCopyMeshCore(RuvmMesh *ruvmMesh,
                                                 RuvmMesh *workMesh);
RUVM_BLENDER_EXPORT void ruvmBlenderCopyMeshAttribs(RuvmMesh *ruvmMesh,
                                                    RuvmMesh *workMesh);
